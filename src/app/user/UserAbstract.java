...
public abstract class UserAbstract {
     ...
     * Wrapped
     *
     * @param visitor the visitor for the design pattern
     * @return user abstract wrapped
     */
    public abstract LinkedHashMap<String, Object> wrapped(Visitor visitor);
     ...
     * @return message
     */
    public abstract String emptyWrapped();
}
